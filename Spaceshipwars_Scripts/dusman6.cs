...
public class dusman6 : MonoBehaviour
{
    ...
    float can = 400.0f;
    float simdiki_can = 400.0f;
    float hareket_hizi = -3.8f;
    float kursun_hizi = 650.0f;

    float ates_etme_araligi = 0.6f;
    ...
    private void can_azalt(float deger)
    {
        ...
        Debug.Log(simdiki_can.ToString());
