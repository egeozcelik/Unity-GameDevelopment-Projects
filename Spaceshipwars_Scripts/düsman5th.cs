...
public class düsman5th : MonoBehaviour
{
    ...
    float can = 350.0f;
    float simdiki_can = 350.0f;
    float hareket_hizi = -3f;
    float kursun_hizi = 600.0f;

    float ates_etme_araligi = 0.3f;
    ...
    {
        GameObject yeni_kursun = Instantiate(dusman_kursunu, transform.position, Quaternion.Euler(0f, 0f, 180f));
    ...
    private void can_azalt(float deger)
    {
        ...
        Debug.Log("düsman cani:" + simdiki_can.ToString());
